    ...
    <nav className="bg-blue-600 p-4 text-white">
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex space-x-4">
          ...
          <a href="/manage" className="hover:bg-blue-700 px-3 py-2 rounded-md text-sm font-medium">
            Manage
          </a>
          <a href="/profile" className="hover:bg-blue-700 px-3 py-2 rounded-md text-sm font-medium">
            Profile
          </a>
        </div>
        <button
