...
- [ ] **Task 1 — Schema: add indexes to Event table (R9)**
...
- [ ] **Task 2 — Auth: require JWT on GET /events; scope by role (R1)**
...
- [ ] **Task 5 — Event payload validation (R8)**
...
- [ ] **Task 6 — Endpoint: GET /analytics/urls/:shortId/clicks (R4)**
...
- [ ] **Task 7 — Endpoint: GET /analytics/summary (admin, R5)**
...
- [ ] **Task 8 — Endpoint: GET /analytics/top-urls (admin, R6)**
